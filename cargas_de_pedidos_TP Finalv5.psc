Algoritmo cargas_de_pedidos
	Definir productos, nombre_producto, opcion_continuar, nombre_apellido, dias, dias_habilitados, franja_horaria, numero_de_contacto, mail Como Caracter;
	Definir ventas, cantidad_articulos, opcion_producto, i, k, z, cantidad, franja_habilitada Como Entero
	...
	Para k <- 1 Hasta 5 Con Paso 1 Hacer
		Escribir "Ingrese los días habilitados de entrega ", k;
	...
	Para z <- 1 Hasta 3 Con Paso 1 Hacer
		Escribir "Ingrese las franjas horarias habilitadas ", z;
	...
	Repetir
		Si opcion_producto >= 6 Entonces // ingresa una opción no valida le solicita una nueva
			Repetir
	...
	Escribir "Será preparado para ser retirado el ", dias[dias_habilitados], " de ", franja_horaria[franja_habilitada];
